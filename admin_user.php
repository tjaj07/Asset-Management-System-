    ...
    <?php
      if (isset($_SESSION['u_uid'])){
        echo '<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
          ...
          echo'</li>
              <li><a style="margin-left:10px;" class="nav-link" href="additem2.php">Add Item</a></li>
            </ul>
            ...
            <form class="form-inline my-2 my-lg-0" action="include/logout.inc.php" method="POST">
              <button style="margin-right:70px;" class="btn btn-outline-success my-2 my-sm-0" type="submit" name="submit">Logout</button>
            </form>
          </div>
        </nav>';
          include "search.php";
